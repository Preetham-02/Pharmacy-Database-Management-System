...
public class Doctor_Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spll = new javax.swing.JTextField();
        ...
        jTextField2.setBounds(105, 111, 110, 30);
        ...
        jTextField4.setBounds(105, 208, 110, 30);

        spll.setForeground(new java.awt.Color(153, 153, 153));
        spll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                spllActionPerformed(evt);
            }
        });
        getContentPane().add(spll);
        spll.setBounds(251, 203, 153, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniproject/Images/page/doctor/doc upd.jpg"))); // NOI18N
        ...
        jScrollPane1.setBounds(50, 420, 452, 290);
        ...
        jButton2.setBounds(160, 380, 220, 23);
    ...
    private void spllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_spllActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_spllActionPerformed
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String phy=new String();
        String spl=new String();      
        phy=phys.getText();
        spl=spll.getText();
       
        if(phy.equals("")||spl.equals(""))
        {
        ...
        try
        {
            ...
            String sel ="select * from doctor where phys_id='"+phy+"'";
            String upd="update doctor set speciality='"+spl+"' where phys_id='"+phy+"'";
            ResultSet rs=st.executeQuery(sel);
            if(rs.next())
            {
                ResultSet rs1=dst.executeQuery(upd);
    ...
    private javax.swing.JTextField spll;
