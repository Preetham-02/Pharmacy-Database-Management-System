 ...
 * @author user
 */
public class Pharmacy_Search extends javax.swing.JFrame {

    /**
     * Creates new form Patient
     */
    public Pharmacy_Search() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(120, 100, 86, 28);
        ...
        jButton7.setBounds(190, 240, 200, 23);
        ...
        jButton10.setBounds(190, 290, 200, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniproject/Images/page/Pharmacy/sear.jpg"))); // NOI18N
        ...
        jScrollPane1.setBounds(50, 390, 452, 270);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try
        {
            ...
            String s="select * from pharmacy where phar_id='"+id+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pharmacy_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
