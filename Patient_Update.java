...
public class Patient_Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(180, 380, 200, 23);
        ...
        jTextField4.setBounds(110, 210, 150, 30);
        ...
        jButton6.setBounds(180, 310, 200, 23);
        ...
        jButton10.setBounds(180, 350, 200, 23);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniproject/Images/page/Patient/upd.jpg"))); // NOI18N
        ...
        jScrollPane1.setBounds(10, 430, 611, 268);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try
        {
            ...
            Connection con=DriverManager.getConnection(url, user, pwd);
            Statement st=con.createStatement();
            String s="update patient set address='"+addre+"' where p_id='"+pid+"'";
